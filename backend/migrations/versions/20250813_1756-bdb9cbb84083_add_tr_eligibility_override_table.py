...
def upgrade() -> None:
    ...
    op.create_table('tr_eligibility_overrides',
    ...
    op.create_index(op.f('ix_tr_eligibility_overrides_collaborator_id'), 'tr_eligibility_overrides', ['collaborator_id'], unique=False)
    op.create_index(op.f('ix_tr_eligibility_overrides_email'), 'tr_eligibility_overrides', ['email'], unique=False)


def downgrade() -> None:
    # Drop TR eligibility override table
    op.drop_index(op.f('ix_tr_eligibility_overrides_email'), table_name='tr_eligibility_overrides')
    op.drop_index(op.f('ix_tr_eligibility_overrides_collaborator_id'), table_name='tr_eligibility_overrides')
