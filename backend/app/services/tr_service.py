...
from app.models.payfit import PayfitAbsence, PayfitEmployee
...
class TRService:
    ...
    async def get_employee_absences(
        ...
        employee_query = (
            ...
            .where(func.lower(PayfitEmployee.email) == email.lower())
            .limit(1)
        )
        ...
        if not payfit_employee:
            ...
            return {"email": email, "absence_days": 0, "absences": []}
        ...
        for absence in absences:
            ...
            while current_date <= end:
                ...
                if (
                    ...
                    and current_date not in self.fr_holidays
                ):
    ...
    async def calculate_tr_rights(
        ...
        # Calculate TR rights
        tr_rights = (
            working_days_info["working_days_count"] - absences_info["absence_days"]
        )
    ...
    async def calculate_all_tr_rights(self, year: int, month: int) -> Dict[str, Any]:
        ...
        overrides_by_email = {
            override.email.lower(): override for override in overrides
        }
        ...
        logger.info(
            f"Found {len(eligible_collaborators)} eligible collaborators for TR rights calculation"
        )
