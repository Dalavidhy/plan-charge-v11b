...
class Project(BaseModel, SoftDeleteMixin):
    ...
    status = Column(
        Enum("proposed", "active", "paused", "done", "cancelled", name="project_status"),
        nullable=False,
        default="proposed",
    )
...
class TaskDependency(BaseModel):
    ...
    depends_on = relationship("Task", foreign_keys=[depends_on_task_id], back_populates="dependent_on")