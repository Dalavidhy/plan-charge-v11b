...
class Allocation(BaseModel):
    ...
    breakdowns = relationship("AllocationBreakdown", back_populates="allocation", cascade="all, delete-orphan")
...
class AllocationBreakdown(BaseModel):
    ...
    __table_args__ = (
        UniqueConstraint("allocation_id", "date", name="uq_allocation_breakdowns_allocation_date"),
