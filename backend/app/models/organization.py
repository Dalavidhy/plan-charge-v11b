...
class Organization(BaseModel, SoftDeleteMixin):
    ...
    calendars = relationship("Calendar", back_populates="organization", cascade="all, delete-orphan")
    users = relationship("User", back_populates="organization", cascade="all, delete-orphan")
    external_providers = relationship("ExternalProvider", back_populates="organization", cascade="all, delete-orphan")
    benefit_types = relationship("BenefitType", back_populates="organization", cascade="all, delete-orphan")
