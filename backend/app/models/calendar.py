...
class Calendar(BaseModel, SoftDeleteMixin):
    ...
    __table_args__ = (
        UniqueConstraint("org_id", "name", name="uq_calendars_org_name"),
    )
...
class Holiday(BaseModel):
    ...
    __table_args__ = (
        UniqueConstraint("calendar_id", "date", "label", name="uq_holidays_calendar_date_label"),
...
class Capacity(BaseModel):
    ...
    __table_args__ = (
        UniqueConstraint("person_id", "period_start", name="uq_capacities_person_start"),
