...
from sqlalchemy import Column, Date, ForeignKey, String, UniqueConstraint, Index
...
class TeamMember(BaseModel):
    ...
    __table_args__ = (
        UniqueConstraint("team_id", "person_id", "active_from", name="uq_team_members_team_person_from"),
