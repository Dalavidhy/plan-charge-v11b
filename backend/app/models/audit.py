...
class AuditLog(BaseModel):
    ...
    __table_args__ = (
        Index("ix_audit_logs_org_entity", "org_id", "entity_type", "entity_id", "created_at"),
...
class ApiToken(BaseModel):
    ...
    # Relationships
    created_by_user = relationship("User", back_populates="api_tokens", foreign_keys=[created_by])
