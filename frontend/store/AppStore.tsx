...
export type Collaborateur = {
  ...
  eligibleTR: boolean;
  actif: boolean;
  droitMensuel?: number; // nombre de tickets/mois (mock)
};
...
const initialCollaborateurs: Collaborateur[] = Array.from({ length: 20 }).map((_, i) => ({
  id: `c${i + 1}`,
  nom: [
    "Alice Martin","Hugo Bernard","Chloé Dupont","Lucas Petit","Léa Moreau",
    "Nathan Lefèvre","Emma Garcia","Louis Mercier","Inès Laurent","Noah Faure",
    "Jade Roux","Ethan Renaud","Zoé Fontaine","Tom Ribeiro","Camille Robin",
    "Maël Nicolas","Lina Collet","Adam Marchand","Louna Perrot","Raphaël Texier"
  ][i],
  eligibleTR: i % 2 === 0,
  actif: i % 5 !== 0, // quelques inactifs
  droitMensuel: 18,
}));
